                        ...
                        <div class="card overflow-hidden">
                            <div class="bg-login text-center">
                                ...
                                <div class="position-relative">
                                    ...
                                    <p class="text-white-50 mb-0">Forgot Password.</p>
                            ...
                            <div class="card-body pt-5">
                                <div class="p-2">
                                    <form class="form-horizontal" method="post" action="<?= base_url() ?>Ct_dashboard/VerifyForgotEmail">
                                        <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="email" name="email" placeholder="Enter Your Email To Reset New Password" >
                                        </div>
