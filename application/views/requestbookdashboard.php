...
<script type="text/javascript">
    $("#datatable-buttons1").dataTable({
        ...
        initComplete: function () {
            ...
            Mon +='</select>';
             ...
             var date1 = '<div id="reportrange3" class="custom-date" style="float:left;">';
                    // date1 +='<i class="fa fa-calendar"></i>&nbsp;';
                    date1 +='<span></span> <i class="bx bx-calendar"></i>';
                    date1 +='</div><input type="hidden" id="rangesbook">';
            ...
            ?>
            cClass +='</select>';
            $(cClass).insertAfter($("#reportrange3"));
    ...
    setTimeout(function(){
        $("#rangesbook").val('<?php echo $start." - ".$end; ?>');
    },1000)
