            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        // }
                        $userInfo = $this->user->getRows(array('id'=>$serviceCenter[0]['dl_created_by']));
                        ?>
                        <div class="row">
                            <div class="col-lg-4"><h5><b><?= $serviceCenter[0]['dl_name'] ?></b></h5></div>
                            <div class="col-lg-4">ID: <b><?= $serviceCenter[0]['dl_reference'] ?></b></div>
                            <div class="col-lg-4"><a href="<?= base_url() ?>Ct_dealer/editService/<?= $serviceCenter[0]['dl_id'] ?>" class="btn btn-primary btn-sm float-right">Edit</a></div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12"><p><?= $serviceCenter[0]['dl_email'] ?></div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12"><p><i class="mdi mdi-map-marker"></i> <?= $serviceCenter[0]['dl_location'] ?></p></div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12"><p><i class="mdi mdi-phone"></i> +91 <?= $serviceCenter[0]['dl_contact'] ?></p><hr></div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4"><b>Created By : </b> <?= isset($userInfo['name']) ? $userInfo['name'] : "" ?></div>
                            <div class="col-lg-8"><b>Created Date : </b> <?= date('d/m/Y', strtotime($serviceCenter[0]['dl_created_date'])) ?></div>
                        </div>
