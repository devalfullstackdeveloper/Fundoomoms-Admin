            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" id="createPackage" action="<?= base_url() ?>Ct_class/addpackage"  enctype="multipart/form-data">
                                ...
                                <div class="col-lg-6">
                                    <div>
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" name="ptitle" id="ptitle" class="form-control" placeholder="Package Title" maxlength="35">
                                        </div>
                                        <div class="form-group mb-4 freeDays" style="display: none;">
                                                <label for="descr">Free Days</label>
                                               <input type="text" name="pdays" id="pdays" class="form-control" maxlength="3" placeholder="Days of Free Package">
                                        </div>
