                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-5">
                                <div class="p-2">
                                    <form class="form-horizontal" method="post" action="<?= base_url() ?>Ct_dashboard/LoginUser">
                                        <?php
                                        /* Alert Message */
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" <?php if(isset($_COOKIE['YORKUSERPASS'])){ echo "checked"; } ?> class="custom-control-input" name="remember" id="customControlInline">
