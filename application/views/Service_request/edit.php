            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" id="editServiceRequest" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id" id="serId" value="<?= $serviceData['ser_id']; ?>">    
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="vehicleLoc" tabindex="1" name="vehicleLoc" class="form-control input-mask" value="<?= $serviceData['vehicle_location']; ?>" onblur="GetRegion();">
                                            <input type="hidden" name="region" id="region" value="<?= $serviceData['region'] ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="trailertype" id="trailertype" class="form-control"  tabindex="5">
                                                ...
                                                ?>
                                                    <option value="<?= $traler['tt_id']; ?>" <?php if($traler['tt_id']==$serviceData['trailer_type']){  echo "selected"; } ?>><?= $traler['tt_name']; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="drivercontact" tabindex="9" maxlength="14"  name="drivercontact" class="form-control input-mask contact" value="+91|<?= $serviceData['driver_contact']; ?>" >
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" tabindex="10" class="custom-control-input selcust" name="customer1" id="existingCustomer" value="existcust" <?php if($serviceData['new_cust']=="1"){   }else{ echo "checked"; } ?> >
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" tabindex="10"  class="custom-control-input selcust" name="customer1" id="addnewcust" value="newcust" <?php if($serviceData['new_cust']=="1"){  }else{  } ?>>
                                        ...
                                        <div class="form-group custSelect">
                                            ...
                                            <select class="form-control select2" name="customer" tabindex="11" id="customer" >
                                                ...
                                                ?>
                                                <option value="<?= $value['id']; ?>" <?php if($value['id']==$serviceData['customer']){ echo "selected"; } ?>><?= $value['name']; ?></option>
                                                <?php        
                                                    }
                                                ?>
                                            </select>
                                ...
                                <div class="col-lg-4">
                                    <div class="">
                                        <div class="form-group">
                                            ...
                                            <input id="vehicleregno" name="vehicleregno" tabindex="2" type="text" class="form-control input-mask" placeholder="--|--|--|----" value="<?= $serviceData['veh_regno'] ?>" >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="defect" id="defect" class="form-control" tabindex="6">
                                                ...
                                                ?>
                                                    <option value="<?= $defect['dd_id']; ?>" <?php if($defect['dd_id']==$serviceData['defect_detail']){ echo "selected"; } ?>><?= $defect['dd_name']; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        <div class="form-group">
                                            ...
                                            <input id="vehicleregdate" name="vehicleregdate" tabindex="3"  max="<?php echo date("Y-m-d"); ?>" type="date" class="form-control input-mask" value="<?= $serviceData['veh_regdate']; ?>" >
                                        </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="">
                                        <div class="form-group">
                                            ...
                                            <input id="kmrun" name="kmrun" tabindex="4" type="text" class="form-control input-mask" placeholder="KM" value="<?= $serviceData['km_run']; ?>">
                                        </div>
